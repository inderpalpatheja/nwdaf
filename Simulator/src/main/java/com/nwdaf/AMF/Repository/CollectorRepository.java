package com.nwdaf.AMF.Repository;


import com.nwdaf.AMF.Mapper.CollectorRowMapper;
...
public class CollectorRepository {
    ...
    public List<Namf_EventExposure_Subscribe> subscriptionDetails() {
        ...
        return jdbcTemplate.query("SELECT nfId, eventId, notificationTargetAddress, correlationId, unSubCorrelationId FROM subscriptionTable", new CollectorRowMapper());
