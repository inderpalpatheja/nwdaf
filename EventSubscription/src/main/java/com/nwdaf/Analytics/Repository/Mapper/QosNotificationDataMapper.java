...
public class QosNotificationDataMapper implements RowMapper {
    ...
    public Object mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        { return new QosNotificationData(resultSet.getString("subscriptionId"), resultSet.getString("tai"),resultSet.getInt("ranUeThrouThrd"), QosType.RAN_UE_THROUGHPUT); }

        else if(qosType == QosType.QOS_FLOW_RETAIN)
        { return new QosNotificationData(resultSet.getString("subscriptionId"), resultSet.getString("tai") ,resultSet.getInt("qosFlowRetThrd"), QosType.QOS_FLOW_RETAIN); }
