...
*/
    ...
    // get method to get AMF sub to check JSON format
    @RequestMapping("/getNamf_EventExposure_Subscribe")
    public List<Namf_EventExposure_Subscribe> getNamf_EventExposure_Subscribe() {

        return namf_eventExposure_subscribeArrayList;
    }

    // POST method for [AMF] Sub
    @RequestMapping(method=RequestMethod.POST, value="/Namf_EventExposure_Subscribe")
    public void postNamf_EventExposure_Subscribe(@RequestBody Namf_EventExposure_Subscribe namf_eventExposure_subscribe) {

        System.out.println("Event Subscription added.!");
        namf_eventExposure_subscribeArrayList.add(namf_eventExposure_subscribe);

    }

    // get method of get AMF UnSub to check Json Format
